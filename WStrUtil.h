...
public:
	...
	static std::wstring pathAddSlash(const std::wstring& path);
	static std::wstring pathRemoveSlash(const std::wstring& path);
	static std::wstring pathAddPath(const std::wstring& path, const std::wstring& subpath);
	typedef std::pair<const std::wstring, const std::wstring> pathPair;
	static const pathPair pathSplitPath(const std::wstring& path);
